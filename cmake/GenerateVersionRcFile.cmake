...
#   VERSION_PATCH             - Default: 0
#   VERSION_TWEAK             - Default: 0
...
function(generate_version_rcfile rcfile)
  ...
  if(DEFINED PROJECT_VERSION
    ...
    if(PROJECT_VERSION_MAJOR AND NOT "${PROJECT_VERSION_MAJOR}" STREQUAL "")
      set(VERSIONRC_VERSION_MAJOR ${PROJECT_VERSION_MAJOR})
    else()
      set(VERSIONRC_VERSION_MAJOR 1)
    endif()
    if(PROJECT_VERSION_MINOR AND NOT "${PROJECT_VERSION_MINOR}" STREQUAL "")
      set(VERSIONRC_VERSION_MINOR ${PROJECT_VERSION_MINOR})
    else()
      set(VERSIONRC_VERSION_MINOR 0)
    endif()
    if(PROJECT_VERSION_PATCH AND NOT "${PROJECT_VERSION_PATCH}" STREQUAL "")
      set(VERSIONRC_VERSION_PATCH ${PROJECT_VERSION_PATCH})
    else()
      set(VERSIONRC_VERSION_PATCH 0)
    endif()
    if(PROJECT_VERSION_TWEAK AND NOT "${PROJECT_VERSION_TWEAK}" STREQUAL "")
  ...
  if(NOT DEFINED VERSIONRC_PRODUCT_VERSION_MAJOR
    ...
    if(NOT VERSIONRC_PRODUCT_VERSION_MAJOR)
      set(VERSIONRC_PRODUCT_VERSION_MAJOR 1)
    endif()
    if(NOT VERSIONRC_PRODUCT_VERSION_MINOR)
      set(VERSIONRC_PRODUCT_VERSION_MINOR 0)
    endif()
    if(NOT VERSIONRC_PRODUCT_VERSION_PATCH)
      set(VERSIONRC_PRODUCT_VERSION_PATCH 0)
    endif()
    if(NOT VERSIONRC_PRODUCT_VERSION_TWEAK)
